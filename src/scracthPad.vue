  ...
  <div id="app">
    <div style="display: inline-block; padding: 0px 0px 20px 200px">
      <label style="padding: 30px 17px 0 0; font-weight: bold">
        Select row rendering mode :</label
      >
      <ejs-dropdownlist
        ref="dropdown"
        index="0"
    ...
    <div class="e-adaptive-demo e-bigger">
            ...
            <e-aggregates>
              <e-aggregate>
                <e-columns>
                  ...
                  <template v-slot:sumTemplate="{ data }"
                    ><span>Total Models: {{ data.Count }}</span></template
                  >
                </e-columns>
              </e-aggregate>
            </e-aggregates>
      ...
      <div className="datalink">
        ...
        <a
          ...
          target="_blank"
          >Wikipedia: List of Android smartphones</a
        >
      </div>
    </div>
  </div>
...
const load = function () {
  grid.value.ej2Instances.adaptiveDlgTarget =
